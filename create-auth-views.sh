...
# Create Login.cshtml
cat > src/FriendShare.Web/Views/Auth/Login.cshtml << 'EOF'
...
cat > src/FriendShare.Web/Views/Auth/Register.cshtml << 'EOF'
...
cat > src/FriendShare.Web/Views/Auth/ForgotPassword.cshtml << 'EOF'
...
# Create ConfirmEmail.cshtml
cat > src/FriendShare.Web/Views/Auth/ConfirmEmail.cshtml << 'EOF'
@{
...
echo "Auth views created successfully!"
echo "Files created:"
echo "  - src/FriendShare.Web/Views/Auth/Login.cshtml"
echo "  - src/FriendShare.Web/Views/Auth/Register.cshtml"
echo "  - src/FriendShare.Web/Views/Auth/ForgotPassword.cshtml"
echo "  - src/FriendShare.Web/Views/Auth/ConfirmEmail.cshtml"
